                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="dashboard-wrapper dashboard-user-profile">
                            <div class="media">
                                <form method="post" action="<?= base_url('pegawai/editProfile/' . $d['id_pegawai']); ?>">
                                    <div class=" mt-3 mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Name</label>
                                        <input type="text" class="form-control" id="name" name="name" value="<?= $d['nama_pegawai'] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Username</label>
                                        <input type="text" class="form-control" id="username" name="username" value="<?= $d['username_pegawai'] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">No Hp Pegawai</label>
                                        <input type="text" class="form-control" id="noHP_pegawai" name="noHP_pegawai" value="<?= $d['noHP_pegawai'] ?>">
                                    </div>
